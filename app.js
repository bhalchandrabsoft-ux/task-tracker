...
const Storage = (function(){
  ...
  async function clearAll(){
    await Promise.all(["employees","tasks","holidays","records","settings"].map(clear));
  }

  async function getSetting(key, fallback){
    const os = await tx("settings", "readonly");
  ...
  return { getAll, put, bulkPut, del, clear, clearAll, getSetting, setSetting, exportAll, importAll };
})();
